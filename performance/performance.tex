...
% WB: this needs some review as the distributions are not gaussian and the effective sigma is different. The detector should be judged in terms of applying cuts to identify beam bunces. In this regards we have a perfomance of the order or 94% when the machine runs at 500MHz

% therefore this needs to be expanded on
